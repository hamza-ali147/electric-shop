                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('articles.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <textarea name="text" id="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg" cols="30" rows="10"  value="{{ old('text') }}" placeholder="Content" ></textarea>
                                
                            </div>
                            <label for="" class="text-lg font-medium">Author</label>
                            <div class="my-3">
                                <input value="{{ old('author') }}" name="author" placeholder="Enter Author Name" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                                @error('author')
                                    <p class="text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
