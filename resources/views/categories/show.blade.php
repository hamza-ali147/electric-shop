...
@section('body')
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <!-- Category Detail Card with Animation -->
                <div class="card shadow-sm animated fadeInUp w-50">
                    <img src="{{ asset("storage{$category->thumbnail}") }}" alt="Thumbnail not found" class="card-img-top" />
                    <div class="card-body">
                        <h2 class="card-title"><strong>Name:</strong>{{ $category->name }}</h2>
                        <p class="card-text"><strong>Detail for Category:</strong> {{ $category->name }}</p>
